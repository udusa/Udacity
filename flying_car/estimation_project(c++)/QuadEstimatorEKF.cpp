...
void QuadEstimatorEKF::UpdateFromIMU(V3F accel, V3F gyro)
{
  ...
  // make sure you comment it out when you add your own code -- otherwise e.g. you might integrate yaw twice
    ...
    float predictedPitch = qt_bar.Pitch();//pitchEst + dtIMU * gyro.y;
    float predictedRoll = qt_bar.Roll();//rollEst + dtIMU * gyro.x;
    ekfState(6) = qt_bar.Yaw();//ekfState(6) + dtIMU * gyro.z;	// yaw
